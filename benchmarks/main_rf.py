...
def main(args):
    ...
    print("Fitting RandomForestClassifier from the training data set")
    clf = RandomForestClassifier(random_state=0, class_weight='balanced', max_features=args.max_features, n_estimators=args.n_estimators, min_samples_leaf=args.min_samples_leaf).fit(inputs[train_idx], outcomes[train_idx])
